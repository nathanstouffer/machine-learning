...
% TODO insert figure reference here
In viewing figure blank, the K-NN learner's average accuracy is 
% TODO insert accuracy
which is abysmal.
In the abalone dataset, the goal is to classify the age of an abalone muscle. However, there are 29 ages and consecutive ages would be closely related to each other.
