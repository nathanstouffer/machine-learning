...
public class Euclidean implements IMetric {
    ...
    /**
     * method to compute the distance between two examples
     * in Euclidean, straight line distance
     * @param ex1
     * @param ex2
     * @return 
     */
    public double dist(Example ex1, Example ex2){ return Math.sqrt(squaredDist(ex1, ex2)); }
     ...
     * @return 
     */
    private double squaredDist(Example ex1, Example ex2){
