...
//        System.out.println("FEED FORWARD VAL " + output);
    ...
    /**
     * method to set the weights of a layer
     * @param mtx 
     */
    public void setWeights(Matrix mtx) { this.weights = mtx; }
    
    public int getNumNodes() { return this.weights.getNumRows(); }
    public int getNumInputs() { return this.weights.getNumCol(); }
    public int getNumWeights() { return this.getNumInputs() * this.getNumNodes(); }
